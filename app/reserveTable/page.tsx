...
return(
  ...
  {/* Left side: Logo and Restaurant Name */}
        <div className="flex items-center space-x-2  ml-5">
            ...
            <h1 className="text-xl font-semibold text-gray-500">Lé Méridien</h1>
        </div>
    ...
    <Table/>
    <Card className="w-1/4 bg-slate-200 pt-5 flex items-center justify-center flex-col" style={{height:"105vh"}}>
